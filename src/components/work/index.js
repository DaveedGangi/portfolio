...
class Work extends Component {
    ...
    <div className="card-body">
        ...
        <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://wordflowappdaveedgangi.netlify.app" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
 ...
 <div className="card">
                    <img className="card-img-top" src="https://i.ibb.co/Wv8Gg8Cg/Screenshot-2025-08-13-164321.png" alt="not-found"/>
                    <div className="card-body">
                        <h5 className="card-title">URL Shortener App</h5>
                        <p className="card-text">A fast, minimal tool to convert long links into short, shareable URLs.
      Built with React, Express, and MongoDB. Paste → Shorten → Share 🚀 </p>
                            <div className="github-links">
                                <a
                                    href="https://github.com/DaveedGangi/urlShortenerFrontend.git"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="github-link"
                                >
                                ...
                                <a
                                    href="https://github.com/DaveedGangi/urlShortenerBackend.git"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="github-link"
                                >
                        ...
                        <a href="https://urlshortenerdaveed.netlify.app/" target="_blank" rel="noreferrer" className="btn btn-primary"> Live Demo<i className="fa-solid fa-arrow-right"></i></a>
  ...
  >
    ...
    Frontend
                        ...
                        <a href="https://todoappreactdaveed.onrender.com" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
  ...
  >
    ...
    Frontend
                        ...
                        <a href="https://daveedsimplecalculator.netlify.app/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
        ...
        <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://jobsandbookmarksdaveedgangi.netlify.app/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
        ...
        <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://chatbotdaveed.netlify.app/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
        ...
        <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://weatherappdaveed.netlify.app/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedPrimeVi.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveednextt.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedjobby.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
             ...
             <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedmoviesapp.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedpopularre.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedevents.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedstopwatch.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedipldashbo.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedfetchrou.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedbloglist.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedMatchGame.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedPasswordM.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedEmojiGame.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedCoinToss.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedAppStore.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://DaveedCommentAp.ccbp.tech" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://daveedtodos.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
            ...
            <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="https://gdaveedtourism.ccbp.tech/" target="_blank" rel="noreferrer" className="btn btn-primary">Live Demo<i className="fa-solid fa-arrow-right"></i></a>
                    </div>
            </div>
